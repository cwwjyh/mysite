...
class LoginForm(forms.Form):
	...
	password = forms.CharField(label='密码', 
								...
								attrs={'class':'form-control', 'placeholder':'请输入密码'}))#widget=forms.PasswordInput此句把密码设置为密文
...
class ChangePasswordForm(forms.Form):#创建修改密码的表单
	old_password = forms.CharField(
		label='旧的密码', 
		widget=forms.PasswordInput(
				attrs={'class':'form-control', 'placeholder':'请输入旧的密码'}#widget=forms.PasswordInput此句把密码设置为密文
		)
	)
	new_password = forms.CharField(
		label='新的密码', 
		widget=forms.PasswordInput(
				attrs={'class':'form-control', 'placeholder':'请输入新的密码'}#widget=forms.PasswordInput此句把密码设置为密文
		)
	)
	new_password_again = forms.CharField(
		label='请再次输入新的密码', 
		widget=forms.PasswordInput(
				attrs={'class':'form-control', 'placeholder':'请再次输入请输入新的密码'}#widget=forms.PasswordInput此句把密码设置为密文
		)
	)
